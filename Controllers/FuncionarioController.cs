...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        _context.SaveChanges(); // Chamar o método SaveChanges do _context para salvar no Banco SQL

        var tableClient = GetTableClient();
        var funcionarioLog = new FuncionarioLog(funcionario, TipoAcao.Inclusao, funcionario.Departamento, Guid.NewGuid().ToString());
        tableClient.UpsertEntity(funcionarioLog); // Chamar o método UpsertEntity para salvar no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // Completar outras propriedades que precisam ser atualizadas

        _context.Funcionarios.Update(funcionarioBanco); // Chamar o método de Update do _context.Funcionarios para salvar no Banco SQL
    ...
    public IActionResult Deletar(int id)
    {
        ...
        _context.Funcionarios.Remove(funcionarioBanco); // Chamar o método de Remove do _context.Funcionarios para salvar no Banco SQL
        _context.SaveChanges();
